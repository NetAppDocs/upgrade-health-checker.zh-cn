...
NOTE: 确保虚拟机可以通过 HTTPS (443) 连接到自动更新和遥测端点（(https://support.netapp.com/[] 和  https://api.activeiq.netapp.com[]），以启用 NetApp 接收有关升级计划的 AutoSupport 信息。如果互联网访问不可用，您必须手动下载最新版本的 Upgrade Health Checker。
